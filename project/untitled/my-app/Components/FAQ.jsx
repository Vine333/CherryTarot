...
const faqData = [
    ...
    {
        question: "Где можно посмотреть отзывы?",
        answer:
            "Отзывы клиентов можно посмотреть в Instagram в актуальных историях «Отзывы». Там собраны реальные отзывы, скриншоты и впечатления людей после раскладов."
    }
];
